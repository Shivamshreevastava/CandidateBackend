...
/****************************************************
                humber in small screen
 ****************************************************/
        
                window.addEventListener('DOMContentLoaded', event => {
                    const sidebarToggle = document.body.querySelector('#sidebarToggle01');
                    if (sidebarToggle) {
                        sidebarToggle.addEventListener('click', event => {
                            
                               $('.utf-dashboard-responsive-trigger-item').removeClass('active');
                               $('.utf-hamburger-collapse-item').removeClass('is-active');
                               $('.utf-dashboard-nav').removeClass('active');
                             
                            
                        });
                    };
                    const sidebarToggle01 = document.body.querySelector('#sidebarToggle02');
                    if (sidebarToggle01) {
                        sidebarToggle01.addEventListener('click', event => {
                    ...
                    const sidebarToggle03 = document.body.querySelector('#sidebarToggle03');
                    if (sidebarToggle03) {
                        sidebarToggle03.addEventListener('click', event => {
                    ...
                    const sidebarToggle04 = document.body.querySelector('#sidebarToggle04');
                    if (sidebarToggle04) {
                        sidebarToggle04.addEventListener('click', event => {
                    ...
                    const sidebarToggle05 = document.body.querySelector('#sidebarToggle05');
                    if (sidebarToggle05) {
                        sidebarToggle05.addEventListener('click', event => {
                ...
                const sidebarToggle06 = document.body.querySelector('#sidebarToggle06');
                if (sidebarToggle06) {
                    sidebarToggle06.addEventListener('click', event => {
                ...
                const sidebarToggle07 = document.body.querySelector('#sidebarToggle07');
                if (sidebarToggle07) {
                    sidebarToggle07.addEventListener('click', event => {
                ...
                const sidebarToggle08 = document.body.querySelector('#sidebarToggle08');
                if (sidebarToggle08) {
                    sidebarToggle08.addEventListener('click', event => {
