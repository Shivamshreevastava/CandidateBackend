...
export default function Editresume() {
    ...
    const fetch = () =>{
       // console.log((`https://syscorpinc.in/cogent_api/candidateexperience/view/{id}`+id));
        axios.get(`http://localhost/cogent_api/candidateexperience/view/`+id).then((res)=>{
    ...
    const urlPost = "http://localhost/cogent_api/candidate_experience/update"
        ...
        <div className="utf-dashboard-content-container-aera" data-simplebar>
                ...
                <div className="row">
                    ...
                    <div className="utf-centered-button">
                        <Link
                            to=" "
                            className="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-0 margin-bottom-100" onClick={handleSubmit} >Update </Link>
                    </div>
                </div>
            </div>
